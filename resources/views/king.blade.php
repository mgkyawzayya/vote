...
<div class="page-header header-filter" data-parallax="true" style="background-image: url('assets/img/ucspkku.jpg')">
  ...
  <div class="main main-raised">
      <h1 class="text-center title">King List</h1>
      <hr>
      <div class="container">
          <div class="row">
              ...
              <div class="col-lg-4">
                  <div class="card">
                      <div class="card-header card-header-text card-header-primary">
                          <div class="card-text">
                          <h4 class="card-title">{{ $king->name }}</h4>
                          <h6 class="card-title">No - {{ $king->no }}</h6>
                          </div>
                      </div>
                      <div class="card-body">
                          <a href="{{ route('/king/show/' . $king->id) }}" class="btn btn-success rounded">Detail</a>
                      </div>
                  </div>
              </div>
              @endforeach
